          ...
          <div className="grid gap-6 md:grid-cols-12 md:items-end">
            ...
            <div className="pb-1 md:col-span-3 md:col-start-10">
              <p className="text-[12px] leading-5 text-neutral-600">
                We create with a belief that beauty does not need to be
                loud. It can exist in proportion, texture, movement and
                the quiet details that reveal themselves over time.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="grid gap-8 md:grid-cols-12">
            ...
            <div className="md:col-span-8 md:col-start-5">
              ...
              <h2 className="text-2xl font-light leading-[1.15] tracking-[-0.02em] md:text-3xl">
              ...
              <div className="mt-7 grid gap-6 md:grid-cols-2">
                ...
                <div>
                  <p className="text-[12px] leading-6 text-neutral-600">
                    Our approach begins with observation. We look at the
                    spaces around us, the objects we live with and the way
                    people move through the world. These small observations
                    influence everything we create.
                  </p>

                  <p className="mt-4 text-[12px] leading-6 text-neutral-600">
                    Rather than following every new direction, we are
                    interested in developing a point of view that can exist
                    beyond a particular season or moment.
                  </p>
                </div>

                <div>
                  <p className="text-[12px] leading-6 text-neutral-600">
                    Materials, proportion and craftsmanship are central to
                    our process. We believe that an object should feel as
                    considered from a distance as it does when experienced
                    up close.
                  </p>
                  ...
                  <p className="mt-4 text-[12px] leading-6 text-neutral-600">
                    ...
                    contemporary without losing its sense of permanence.
                  </p>
                </div>
        ...
        <div className="mx-auto max-w-[1200px] border-y border-neutral-300 py-10">
          ...
          <div className="grid gap-7 md:grid-cols-12">
            ...
            <div className="md:col-span-8 md:col-start-5">
              ...
              <h2 className="text-3xl font-light leading-[1.05] tracking-[-0.025em] md:text-4xl">
                We choose longevity over excess, character over decoration,
                and intention over noise.
              </h2>
              ...
              <div className="mt-7 grid gap-6 text-[12px] leading-6 text-neutral-600 md:grid-cols-2">
                ...
                <p>
                  ...
                  movement and identity. We see our role as contributing to
                  that conversation while maintaining a clear and personal
                  perspective.
                </p>
