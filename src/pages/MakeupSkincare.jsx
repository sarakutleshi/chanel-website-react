...
const carouselItems = [
  { bg: "https://i.pinimg.com/1200x/20/96/b0/2096b0da603531d74abc658e5e01a3a8.jpg", title: "Rouge Allure Velvet", sub: "Luminous Matte Lip Colour" },
  { bg: "https://i.pinimg.com/vwebp/736x/9f/7e/66/9f7e666c6bb10946d4b4c25e5a736204.webp", title: "Les Beiges", sub: "Healthy Glow Foundation" },
  { bg: "https://i.pinimg.com/vwebp/1200x/42/73/22/427322d9717b9ca8a2d26830520630c4.webp", title: "Inimitable Mascara", sub: "Multi-Dimensional Volume" },
  { bg: "https://i.pinimg.com/vwebp/736x/1f/c2/76/1fc276e6cb804dbde9fed98f8756eb4c.webp", title: "Stylo Yeux", sub: "Waterproof Long-Lasting Eye Liner" },
  { bg: "https://i.pinimg.com/vwebp/1200x/47/41/5e/47415e050d2225d368a3716a28dbb25c.webp", title: "Joues Contraste", sub: "Powder Blush" },
  { bg: "https://i.pinimg.com/1200x/f0/4b/23/f04b2334453e0cb28543b2e42af3a25f.jpg", title: "Ombre Première", sub: "Longwear Powder Eyeshadow" },
];
...
const makeupProducts = [
  ...
  { img: "https://i.pinimg.com/vwebp/736x/92/8d/5c/928d5c0c7d9a459387e189b2238ebb65.webp", category: "Eyes", name: "Le Volume de Chanel", desc: "A volumising mascara that builds intense, structured lashes with a dramatic curved brush.", price: "$38" },
  ...
  { img: "https://i.pinimg.com/vwebp/1200x/e2/35/e5/e235e5c8c02b68d38b42d2c54be9d7d7.webp", category: "Eyes", name: "Ombre Première", desc: "Long-wear powder eyeshadow for a sophisticated, multi-dimensional eye look.", price: "$40" },
...
export default function MakeupSkincare() {
  ...
  const scrollCards = (direction) => {
    if (cardsRef.current) {
      const cardWidth = cardsRef.current.querySelector('.carousel-card')?.offsetWidth || 0;
    ...
    <>
      ...
      <div className="makeup-content-container">
        <div className="makeup-show-case">
          <h1>Make-Up</h1>
          <h2>Express. Enhance. Empower.<br />The power of Make-up</h2>
          <h2>Unleash your inner artist, from subtle enhancements to bold statements, discover the confidence that comes with every stroke of color.</h2>
          <a href="#makeup-products">Shop Products</a>
        </div>
        <div className="makeup-image">
          <img src="https://i.pinimg.com/736x/73/da/34/73da343b96cee6c62068d43ac93ee0fa.jpg" alt="Makeup promotional" />
        </div>
      </div>

      {/* Philosophy */}
      <div className="section-label"><h2>The CHANEL Beauty Philosophy</h2></div>
      ...
      {/* Carousel */}
      <div className="section-label" id="makeup-products"><h2>Makeup Selection</h2></div>
      <div className="cards-wrapper">
        <button className="arrow-btn" onClick={() => scrollCards(-1)} aria-label="Scroll left">&#10094;</button>
        <div className="home-cards" ref={cardsRef}>
          {carouselItems.map((item, i) => (
            <div className="carousel-card" key={i} style={{ backgroundImage: `url(${item.bg})` }}>
        ...
        <button className="arrow-btn" onClick={() => scrollCards(1)} aria-label="Scroll right">&#10095;</button>
      </div>

      {/* Makeup Products */}
      <div className="makeup-grid">
        {makeupProducts.map((item, i) => (
          <article className="makeup-card" key={i}>
      ...
      {/* Skincare */}
      <div className="section-label"><h2>Skincare</h2></div>
      <div className="skincare-hero">
        <div className="skincare-hero-img">
          <img src="https://www.chanel.com/images/q_auto:good,f_auto,fl_lossy,dpr_1.1/w_1920/BEA-featured-products-le-lift-creme-0.jpg" alt="Chanel Skincare" />
        </div>
        <div className="skincare-hero-text">
          <span className="eyebrow-label">Le Lift</span>
          <h2>Discover the Beauty Within</h2>
          <p>CHANEL skincare is rooted in the science of the camomille de Grasse — a flower cultivated exclusively for the House since 1987. Its remarkable properties inspire every formula in the skincare line, from targeted serums to deeply nourishing creams.</p>
          <p style={{ marginTop: '1.25rem' }}>The LE LIFT range harnesses the anti-aging power of a concentrated active ingredient derived from alfalfa, visibly firming and smoothing the skin with each application.</p>
          <a href="#skincare-products" className="text-link">Explore Skincare →</a>
        </div>
      </div>

      {/* Skincare Products */}
      <div className="makeup-grid" id="skincare-products" style={{ marginTop: 0 }}>
