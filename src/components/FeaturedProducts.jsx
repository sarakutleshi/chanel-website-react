  ...
  return (
    <section className="w-full border-t border-neutral-100 bg-white py-14 md:py-20">
      ...
      <div className="w-full">
        <div
          className=" flex w-full gap-4 overflow-x-auto px-6  pb-2 md:px-12  scrollbar-hide snap-x snap-mandatory
          "
        >
          {featured?.map((p) => (
            <div
              key={p.id}
              className="w-[185px] shrink-0 snap-start sm:w-[205px] md:w-[225px] lg:w-[240px]   "
            >
